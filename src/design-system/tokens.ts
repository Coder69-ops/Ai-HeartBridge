/**
 * Design Tokens for AI HeartBridge
 * 2025 Professional Design System
 */

export const designTokens = {
  // Color System - Therapy-focused palette
  colors: {
    ...
    therapy: {
      calm: '#6B73FF',       // Trust, communication
      growth: '#10B981',     // Growth, healing
      warmth: '#F59E0B',     // Warmth, connection
      safe: '#F8FAFC',       // Safety, comfort
      gentle: '#FEF3C7',     // Gentle warnings
      soft: '#FEE2E2',       // Soft error states
    }
  },
...
export type TypographyWeight = keyof typeof designTokens.typography.weights;
