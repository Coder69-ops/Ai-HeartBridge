    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-cyan-50 to-blue-50">
      ...
      <div className="bg-gradient-to-r from-emerald-500 to-cyan-500 text-white px-4 sm:px-6 lg:px-8 pt-6 pb-12">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold">Relationship Exercises</h1>
              <p className="text-white/80 text-sm">Evidence-based activities to strengthen your bond</p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 -mt-6">
        ...
        <motion.div 
          ...
          className="flex gap-2 overflow-x-auto pb-4 no-scrollbar mb-6"
        >
                    ...
                    >
                      ...
                      <CardContent className="p-5">
                        ...
                        <div className="flex items-center justify-between mb-3">
                          <div className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${categoryInfo.color} text-white`}>
                            {categoryInfo.icon}
                        ...
                        <div className="flex items-center gap-3 flex-wrap">
                          ...
                          {/* Difficulty */}
                          <span className={`px-2 py-0.5 rounded-full text-xs font-medium border ${getDifficultyColor(exercise.difficulty)}`}>
                            {exercise.difficulty}
                          </span>
        ...
        {filteredExercises.length > 0 && (
          <motion.div
            ...
            className="mt-8 p-6 bg-white/70 backdrop-blur-sm rounded-2xl border border-gray-200"
          >
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
              <div>
                <div className="text-2xl font-bold text-emerald-600">{filteredExercises.length}</div>
