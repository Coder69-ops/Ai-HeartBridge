      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12 pb-12">
        ...
        {parsedInsights.riskFlags.length > 0 && (
          <motion.div
            ...
            className="mb-6"
          >
            <Card className="shadow-lg bg-gradient-to-br from-red-50 to-rose-50 border-2 border-red-200">
        ...
        >
          ...
          {onContinue && (
            <Button
              onClick={onContinue}
              className="w-full sm:w-auto px-8 py-3 text-lg bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600"
            >
